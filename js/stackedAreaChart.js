...
StackedAreaChart.prototype.initVis = function(start_yr,end_yr){
    ...
    // Scales and axes
    var x_range = [1960,2014]
    if(timeline.brush.empty()==false){
        x_range = timeline.brush.extent();
    }
...
StackedAreaChart.prototype.updateVis = function() {
    ...
    categories.enter().append("path")
        ...
        .on('mousemove', function (d) {
            return vis.tooltip.style("top", (event.pageY - 10) + "px").style("left", (event.pageX + 10) + "px");
        })
